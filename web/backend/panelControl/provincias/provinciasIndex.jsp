<%-- 
    Document   : provinciasIndex.jsp
    Created on : 14-abr-2019, 9:23:11
...
<html lang="es">
    <head>
        ...
        <title>DashBoard - Gestión de Provincias</title>
        ...
        <s:set var="opcionSubMenu" value="'provincias'"/>
        <!-- Left Sidebar -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="breadcrumb-holder">
                                    ...
                                    <h1 class="main-title float-left">Provincias</h1>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <span class="pull-right"><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_add_user"><i class="fa fa-plus" aria-hidden="true"></i> Añadir Provincia</button></span>
                                                ...
                                                <div class="modal-content">
                                                    <form action="javascript:alert('No implementado');" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Añadir provincia</h5>
                                        ...
                                        <h3><i class="fa fa-folder"></i> Existen <s:property value ="listProvincias.size()"/> Provincias</h3>								
                                    </div>
                                    <!-- end card-header -->	
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="provincias" class="table table-bordered">
                                                <thead>
                                                    <tr>
                                                ...
                                                <s:iterator value="listProvincias" var="provincia" status="status">   
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-hidden="true" id="modal_edit_${provincia.idProvincia}">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="ActualizarProvincia" method="post" enctype="multipart/form-data">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">                
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <div class="form-group">
                                                                                            <label>Nombre</label>
                                                                                            <input class="form-control" name="nombre" type="text" required value="${provincia.nombre}" />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>             
                                                            ...
                                                            <a href="javascript:deleteRecord('${provincia.idProvincia}');" class="btn btn-danger btn-sm" data-placement="top" data-toggle="tooltip" data-title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
